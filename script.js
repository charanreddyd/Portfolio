    ...
    reviews.forEach((review, index) => {
        ...
        reviewItem.innerHTML = `
            <div class="admin-review-header">
                <div class="admin-review-name">${review.name}</div>
                <div class="admin-review-date">${review.date}</div>
            </div>
            <div class="admin-review-stars">${starsHtml}</div>
            <div class="admin-review-text">${review.comment || 'No comment provided.'}</div>
...
// Add slideInRight animation for success message
